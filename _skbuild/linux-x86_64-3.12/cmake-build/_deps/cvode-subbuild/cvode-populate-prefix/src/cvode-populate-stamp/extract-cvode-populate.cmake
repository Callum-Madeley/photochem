...
#
get_filename_component(filename "/data/cjm267/photochem/_skbuild/linux-x86_64-3.12/cmake-build/_deps/cvode-subbuild/cvode-populate-prefix/src/cvode-5.7.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/data/cjm267/photochem/_skbuild/linux-x86_64-3.12/cmake-build/_deps/cvode-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cvode-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cvode-populate${i}")
